...
const latLng = `${32.99784257820863},${-94.95779663560516}`;
...
export const HomeScreen = () => {
    ...
    const [region] = useState({
        latitude: 32.99781108457696,
        longitude: -94.95781272885988,
        latitudeDelta: 0.01,
        longitudeDelta: 0.01,
    });
        ...
        <>
            ...
            {/* New Arrival Section with ScrollView */}
                ...
                <ScrollView>
                    ...
                    <View style={styles.sectionTitle}>
                        <Text style={styles.sectionText}> On Sale</Text>
                    </View>
                        ...
                        {/* Rest of the Screen with info and logo */}
                            ...
                            <View style={styles.mapContainer}>
                                ...
                                <MapView
                                    ...
                                    region={region}
                                >
                                    <Marker coordinate={{latitude: 32.9978335800293, longitude: -94.95760888096686}} />
                                </MapView>
                                    <View style={styles.businessHours}>
                                        ...
                                        <Text style={styles.businessHourText}>Mon-Thur = 05:00 AM to 11:00 PM</Text>
                                        <Text style={styles.businessHourText}>Fri-Sat = 05:00 AM to 12:00 AM</Text>
                                        <Text style={styles.businessHourText}>Sun = 07:00 AM to 10:00 PM</Text>
